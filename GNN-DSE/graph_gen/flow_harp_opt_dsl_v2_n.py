...
# Parse opt.tcl and map to (function, label)
...
def create_pragma_nodes(g_nx, g_nx_nodes, for_dict_source, for_dict_llvm, array_dirs=None, log=False):
    ...
    - ARRAY_PARTITION directives are array-scoped:
        ...
        the array.
        Otherwise, attach to variable nodes if found, else near-use nodes
    ...
    # Loop pragmas (PIPELINE / UNROLL->PARALLEL)
    ...
    # ARRAY_PARTITION pragmas (mapped to TILE slot)
